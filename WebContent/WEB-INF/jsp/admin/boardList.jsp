...
<div align="center">
	...
	<table border="0" width="100%">
		<tr>
			<td align="right"><a href="boardWrite.chi">글쓰기</a></td>
		</tr>
	</table>
...
<c:forEach var="dto" items="${listBoard}">
		<tr>
			...
			<c:if test="${dto.re_level>0}">
				...
				<a href="boardContent.chi?num=${dto.num}">
					${dto.subject}
				</a>	
...
<c:if test="${count>0}">
			...
			[<a href="boardList.chi?pageNum=${startPage-pageBlock}">이전</a>]
</c:if>
<c:forEach var="i" begin="${startPage}" end="${endPage}">
			[<a href="boardList.chi?pageNum=${i}">${i}</a>]
</c:forEach>

<c:if test="${endPage<PageCount}">
			[<a href="boardList.chi?pageNum=${startPage+pageBlock}">다음</a>]
</c:if>
</c:if>
</div>
</body>
