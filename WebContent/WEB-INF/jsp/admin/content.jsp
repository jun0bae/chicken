	...
	<table border="1" width="600">
		...
		<tr>
			<td width="80%" align="right" colspan="4">
				...
				<input type="button" value="글수정" onclick="window.location='boardEdit.chi?num=${getBoard.num}'">
				<input type="button" value="글삭제" onclick="window.location='boardDeleteOk.chi?num=${getBoard.num}&&passwd=${getBoard.passwd}'">
				<input type="button" value="글목록" onclick="window.location='boardList.chi'">
			</td>
		</tr>
	</table>
</div>
