...
<body>
<div align="center">
	<form name="f" action="boardEditOk.chi" method="post"
		...
		<table border="1" width="500">
			...
			<tr>
				...
				<td><input type="text" name="passwd" class="box" value="${getBoard.passwd}"></td>
			</tr>
			<tr bgcolor="yellow">
				<td colspan="2" align="center">
					<input type="submit" value="글수정">
					<input type="reset" value="다시쓰기">
					<input type="button" value="목록보기" onclick="window.location='boardList.chi'">
				</td>
			</tr>
		</table>
	</form>
